...
{
    resize(850, 550);
    setWindowTitle(tr("SKYSWEETCOIN") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a SKYSWEETCOIN address"));
...
//    connect(chatAction , SIGNAL(triggered()), this, SLOT(gotoOverviewPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About SKYSWEETCOIN"), this);
    aboutAction->setToolTip(tr("Show information about SKYSWEETCOIN"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for SKYSWEETCOIN"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("SKYSWEETCOIN client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("SKYSWEETCOIN client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to SKYSWEETCOIN network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid SKYSWEETCOIN address or malformed URI parameters."));
    }
