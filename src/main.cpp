...
int64 nChainStartTime = 1486619334;
...
const string strMessageMagic = "SKYSWEETCOIN Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    int64_t nSubsidy = 0 * COIN;
     ...
     if(nHeight == 1) nSubsidy = 500000000 * COIN;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if(nPoWHeight == 1)	 nSubsidy = 500000000 * COIN;
     else         	      	 nSubsidy = 0 * COIN;
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in SKYSWEETCOIN
    bool fStrictPayToScriptHash = true; // Always active in SKYSWEETCOIN
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "SKYSWEETCOIN", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2017.02.09 SKYSWEETCOIN";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("41ee7c7d5f01179a8911ea047c55370924a57750f9a530983f4632955a79500d"));
...
unsigned char pchMessageStart[4] = { 0x75, 0xf5, 0x1c, 0x61 };
