...
bool CWallet::CreateCoinStake(const CKeyStore& keystore, unsigned int nBits, int64 nSearchInterval, CTransaction& txNew)
{
    ...
    // Calculate coin age reward
    {
        ...
        int64 nProofOfStakeReward = GetProofOfStakeReward(nCoinAge, nBits, txNew.nTime, pIndex0->nHeight);
        printf("nCoinAge:%lld, nBits:%d, txNew.nTime:%d, pIndex0->nHeight:%d\n", nCoinAge, nBits, txNew.nTime, pIndex0->nHeight);
        printf("nCredit:%lld, nProofOfStakeReward:%lld, nCoinAge:%lld\n", nCredit, nProofOfStakeReward, nCoinAge);
        nCredit += nProofOfStakeReward;
    }
